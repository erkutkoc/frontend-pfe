...
// .svelte-kit/output/server/chunks/layout-bf9c2b59.js
var layout_bf9c2b59_exports = {};
__export(layout_bf9c2b59_exports, {
  default: () => Layout
});
var Layout;
var init_layout_bf9c2b59 = __esm({
  ".svelte-kit/output/server/chunks/layout-bf9c2b59.js"() {
    init_shims();
    init_app_c042dada();
    init_ssr();
...
// .svelte-kit/output/server/chunks/error-9b127f48.js
var error_9b127f48_exports = {};
__export(error_9b127f48_exports, {
  default: () => Error2,
  load: () => load
});
...
// .svelte-kit/output/server/chunks/Navbar-225d974e.js
var Navbar;
var init_Navbar_225d974e = __esm({
  ".svelte-kit/output/server/chunks/Navbar-225d974e.js"() {
    init_shims();
    init_app_c042dada();
    Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<nav class="${"navbar is-transparent"}"><div class="${"navbar-brand"}"><a class="${"navbar-item"}" href="${"https://bulma.io"}"><img src="${"https://bulma.io/images/bulma-logo.png"}" alt="${"Bulma: a modern CSS framework based on Flexbox"}" width="${"112"}" height="${"28"}"></a>
      <div class="${"navbar-burger"}" data-target="${"navbarExampleTransparentExample"}"><span></span>
        <span></span>
        <span></span></div></div>
  
    <div class="${"navbar-menu"}"><div class="${"navbar-start"}"><a class="${"navbar-item"}" href="${"/"}">Acceuil
        </a>
        <a class="${"navbar-item"}" href="${"/persons"}">Persons
        </a>
        <div class="${"navbar-item has-dropdown is-hoverable"}"><a class="${"navbar-link"}" href="${"/"}">Docs
          </a>
          <div class="${"navbar-dropdown is-boxed"}"><a class="${"navbar-item"}" href="${"/"}">Overview
            </a>
            <a class="${"navbar-item is-active"}" href="${"/"}">Components
            </a></div></div>
        <a class="${"navbar-item"}" href="${"/login"}">Login 
        </a></div></div></nav>`;
    });
  }
});

// .svelte-kit/output/server/chunks/index-e10d8ab7.js
var index_e10d8ab7_exports = {};
__export(index_e10d8ab7_exports, {
  default: () => Routes
});
var Routes;
var init_index_e10d8ab7 = __esm({
  ".svelte-kit/output/server/chunks/index-e10d8ab7.js"() {
    init_shims();
    init_app_c042dada();
    init_Navbar_225d974e();
    init_ssr();
...
// .svelte-kit/output/server/chunks/index-c2d5854a.js
var index_c2d5854a_exports = {};
__export(index_c2d5854a_exports, {
  default: () => MyArticles
});
var MyArticles;
var init_index_c2d5854a = __esm({
  ".svelte-kit/output/server/chunks/index-c2d5854a.js"() {
    init_shims();
    init_app_c042dada();
    init_Navbar_225d974e();
    init_ssr();
    MyArticles = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      return `<main>${validate_component(Navbar, "Navbar").$$render($$result, {}, {}, {})}
    <div class="${"tabs is-centered is-boxed is-medium"}"><ul><li class="${"is-active"}"><a><span class="${"icon is-small"}"><i class="${"fas fa-image"}" aria-hidden="${"true"}"></i></span>
              <span>Pictures</span></a></li>
          <li><a><span class="${"icon is-small"}"><i class="${"fas fa-music"}" aria-hidden="${"true"}"></i></span>
              <span>Music</span></a></li>
          <li><a><span class="${"icon is-small"}"><i class="${"fas fa-film"}" aria-hidden="${"true"}"></i></span>
              <span>Videos</span></a></li>
          <li><a><span class="${"icon is-small"}"><i class="${"far fa-file-alt"}" aria-hidden="${"true"}"></i></span>
              <span>Documents</span></a></li></ul></div></main>`;
    });
  }
});

// .svelte-kit/output/server/chunks/index-66278fa5.js
var index_66278fa5_exports = {};
__export(index_66278fa5_exports, {
  default: () => Persons
});
var Persons;
var init_index_66278fa5 = __esm({
  ".svelte-kit/output/server/chunks/index-66278fa5.js"() {
    init_shims();
    init_app_c042dada();
    init_ssr();
    Persons = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      const fetchPersons = (async () => {
        const response = await fetch("http://localhost:3001/api/persons");
        console.log(response);
        return await response.json();
      })();
      return `<main><div style="${"text-align: center"}">${function(__value) {
        ...
        return function(data) {
          return `
            ${each(data, (person) => `<p>${escape2(person.name)} - ${escape2(person.number)}</p>`)}
        `;
        }(__value);
      }(fetchPersons)}</div></main>`;
    });
  }
});

// .svelte-kit/output/server/chunks/index-5d99390f.js
var index_5d99390f_exports = {};
__export(index_5d99390f_exports, {
  default: () => Login
});
var Login;
var init_index_5d99390f = __esm({
  ".svelte-kit/output/server/chunks/index-5d99390f.js"() {
    init_shims();
    init_app_c042dada();
    init_Navbar_225d974e();
...
<div class="${"min-h-full flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8"}"><div class="${"max-w-md w-full space-y-8"}"><div><h2 class="${"mt-6 text-center text-3xl font-extrabold text-gray-900"}">Sign in to your account
      </h2></div>
...
// .svelte-kit/output/server/chunks/app-c042dada.js
function noop2() {
}
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-38664be0.js",
      css: [assets + "/_app/assets/start-c1dab058.css"],
      js: [assets + "/_app/start-38664be0.js", assets + "/_app/chunks/vendor-d9d69e72.js"]
    },
    fetched: void 0,
    floc: false,
...
${``}`;
    ...
    template = ({ head, body }) => '<!DOCTYPE html>\r\n<html lang="en">\r\n	<head>\r\n		<meta charset="utf-8" />\r\n		<link rel="icon" href="/favicon.ico" />\r\n		<meta name="viewport" content="width=device-width, initial-scale=1" />\r\n		<!-- <link rel="manifest" crossorigin="use-credentials" href="../static/manifest.webmanifest" /> pour PWA --> \r\n		<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bulma@0.9.3/css/bulma.min.css"> <!-- CSS Bulma-->\r\n		<link rel="stylesheet" href="https://rsms.me/inter/inter.css"> <!-- CSS font tailwinds-->\r\n		' + head + '\r\n	</head>\r\n	<body>\r\n		<div id="svelte">' + body + "</div>\r\n	</body>\r\n</html>\r\n";
    options = null;
    default_settings = { paths: { "base": "", "assets": "" } };
    empty = () => ({});
    manifest = {
      assets: [{ "file": "favicon.png", "size": 1571, "type": "image/png" }, { "file": "manifest.webmanifest", "size": 461, "type": "application/manifest+json" }],
      ...
      routes: [
        ...
        },
        {
          ...
          pattern: /^\/myArticles\/?$/,
          params: empty,
          a: [".svelte-kit/build/components/layout.svelte", "src/routes/myArticles/index.svelte"],
          b: [".svelte-kit/build/components/error.svelte"]
        },
        {
          type: "page",
          pattern: /^\/persons\/?$/,
          params: empty,
          a: [".svelte-kit/build/components/layout.svelte", "src/routes/persons/index.svelte"],
          b: [".svelte-kit/build/components/error.svelte"]
        },
        {
          type: "page",
    ...
    module_lookup = {
      ".svelte-kit/build/components/layout.svelte": () => Promise.resolve().then(() => (init_layout_bf9c2b59(), layout_bf9c2b59_exports)),
      ".svelte-kit/build/components/error.svelte": () => Promise.resolve().then(() => (init_error_9b127f48(), error_9b127f48_exports)),
      "src/routes/index.svelte": () => Promise.resolve().then(() => (init_index_e10d8ab7(), index_e10d8ab7_exports)),
      "src/routes/myArticles/index.svelte": () => Promise.resolve().then(() => (init_index_c2d5854a(), index_c2d5854a_exports)),
      "src/routes/persons/index.svelte": () => Promise.resolve().then(() => (init_index_66278fa5(), index_66278fa5_exports)),
      "src/routes/login/index.svelte": () => Promise.resolve().then(() => (init_index_5d99390f(), index_5d99390f_exports))
    };
    metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "layout.svelte-2ce12b1e.js", "css": [], "js": ["layout.svelte-2ce12b1e.js", "chunks/vendor-d9d69e72.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-df1d49d8.js", "css": [], "js": ["error.svelte-df1d49d8.js", "chunks/vendor-d9d69e72.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-0c822417.js", "css": [], "js": ["pages/index.svelte-0c822417.js", "chunks/vendor-d9d69e72.js", "chunks/Navbar-566363a0.js"], "styles": [] }, "src/routes/myArticles/index.svelte": { "entry": "pages/myArticles/index.svelte-b6e5e74b.js", "css": ["assets/tailwind-0658c95e.css"], "js": ["pages/myArticles/index.svelte-b6e5e74b.js", "chunks/vendor-d9d69e72.js", "chunks/Navbar-566363a0.js"], "styles": [] }, "src/routes/persons/index.svelte": { "entry": "pages/persons/index.svelte-b904f948.js", "css": [], "js": ["pages/persons/index.svelte-b904f948.js", "chunks/vendor-d9d69e72.js"], "styles": [] }, "src/routes/login/index.svelte": { "entry": "pages/login/index.svelte-ad698169.js", "css": ["assets/tailwind-0658c95e.css"], "js": ["pages/login/index.svelte-ad698169.js", "chunks/vendor-d9d69e72.js", "chunks/Navbar-566363a0.js"], "styles": [] } };
  }
});
